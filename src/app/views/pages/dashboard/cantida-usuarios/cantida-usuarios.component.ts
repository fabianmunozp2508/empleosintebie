...
@Component({
  selector: 'app-cantida-usuarios',
  templateUrl: './cantida-usuarios.component.html',
  styleUrls: ['./cantida-usuarios.component.scss']
})
export class CantidaUsuariosComponent implements OnInit {
