...
@Component({
  selector: 'app-cantida-empresas',
  templateUrl: './cantida-empresas.component.html',
  styleUrls: ['./cantida-empresas.component.scss']
})
export class CantidaEmpresasComponent implements OnInit {
