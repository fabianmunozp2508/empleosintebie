...
@Component({
  selector: 'app-numero-empleos',
  templateUrl: './numero-empleos.component.html',
  styleUrls: ['./numero-empleos.component.scss']
})
export class NumeroEmpleosComponent implements OnInit {
